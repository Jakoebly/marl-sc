...
def main():
    ...
    print("max_wh_capacities:", [v/10000 for v in data["max_wh_capacities"]])
    print("distances:", data['distances'])
    print("outbound_fixed:", data["outbound_fixed"])
    print("outbound_variable:", data["outbound_variable"])
    print("inbound_fixed:", data["inbound_fixed"])
    print("inbound_variable:", data["inbound_variable"])
    print()
