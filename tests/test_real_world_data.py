...
def test_data_preprocessing():
    ...
    assert preprocessed_data.shipment_costs is not None, "shipment_costs should be created"
    ...
    assert preprocessed_data.shipment_costs.shape == (n_warehouses, n_regions), \
        f"shipment_costs shape should be ({n_warehouses}, {n_regions}), got {preprocessed_data.shipment_costs.shape}"
    print(f"[OK] shipment_costs shape is correct: {preprocessed_data.shipment_costs.shape}")
...
def test_data_consistency():
    ...
    preprocessed_data = preprocessor.preprocess(seed=42)
    ...
    try:
        ...
        np.testing.assert_array_equal(
            ...
            preprocessed_data.shipment_costs
...
if __name__ == "__main__":
    ...
    try:
        ...
        preprocessed_data = test_data_preprocessing()
