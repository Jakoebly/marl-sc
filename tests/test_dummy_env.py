...
def test_reward_calculation():
    ...
    shipment_quantities = np.zeros((env.n_warehouses, env.n_regions))
    shipment_quantities_by_sku = np.zeros((env.n_warehouses, env.n_regions, env.n_skus))
    
    # Calculate rewards
    rewards = env.reward_calculator.calculate(inventory, lost_sales, shipment_counts, shipment_quantities, shipment_quantities_by_sku)
